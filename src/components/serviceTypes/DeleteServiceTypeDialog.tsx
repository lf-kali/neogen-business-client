...
type deleteServiceTypeDialogProps = {
    id: number;
}

function DeleteServiceTypeDialog({id}: deleteServiceTypeDialogProps) {
    ...
    <div className="w-full max-w-md bg-white rounded-xl border border-slate-200 shadow-2xl overflow-hidden">
      ...
      <div className="px-6 py-6">
        <p className="text-sm text-slate-700 leading-relaxed mb-4">
          Você tem certeza que deseja deletar este serviço? Esta ação é
