...
// import type { CreatePortableDevice, DeviceCategory, HandedAccessories, InitialDiagnosis, UpdatePortableDevice } from "../../features/device/types/device.types";
...
//   const [deviceBrands, setDeviceBrands] = useState<DeviceBrand[] | null>(null);
...
//       const {brandList} = useDevicebrands(deviceFormData.type)
